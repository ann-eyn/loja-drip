      ...
      <main className="flex-1 w-full">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="h-10 border border-gray-300 rounded px-3 text-sm focus:ring-1 focus:ring-primary outline-none"
            >
        ...
        <div className="flex justify-end mt-10 w-full border-t pt-6">
          <Link to="/pedidos" className="w-full sm:w-auto">
            <button className="w-full sm:w-auto px-8 py-3 bg-primary hover:brightness-110 text-white font-semibold rounded shadow-md transition-all active:scale-95">
              Ir para o carrinho
            </button>
          </Link>
        </div>
